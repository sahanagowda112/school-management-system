<?php
  ...
  if(isset($_POST['register'])){
    ...
    $query = "insert into students values(null,$_POST[roll_no],'$_POST[fname]','$_POST[lname]','$_POST[mother_name]','$_POST[father_name]','$_POST[dob]','$_POST[gender]','$_POST[category]',$_POST[mobile],$_POST[class],'$_POST[address]','$_POST[status]',0)";
